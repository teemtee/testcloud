...
storage:
  files:
    ...
    CENTOS_STREAM_VERSIONS = {
        ...
        "9":      "https://cloud.centos.org/centos/9-stream/{0}/images/CentOS-Stream-GenericCloud-9-20220606.0.{0}.qcow2",
        "latest": "https://cloud.centos.org/centos/9-stream/{0}/images/CentOS-Stream-GenericCloud-9-20220606.0.{0}.qcow2"
    }
